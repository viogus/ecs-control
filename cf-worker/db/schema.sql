...
CREATE UNIQUE INDEX IF NOT EXISTS idx_th ON traffic_hourly (account_id, recorded_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_td ON traffic_daily (account_id, recorded_at);
